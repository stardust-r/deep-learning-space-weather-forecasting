...
user_config = {
    ...
    "nb_stacks"              : 30,           # nbeats (only if "generic", number of stacks) (if "interpretable", 2 stacks: "trend", "seasonality")
    ...
    "width"                  : 64,           # nbeats (default 128) (number of neurons, hidden_layer_units)
    ...
    "use_wandb"           : True,               # "wandb_mode" : "run" or "dryrun" (run online or offline)
    "sweep"               : True,               # single run or part of larger sweep
    "verbose"             : True,                # printout during run
    "plot"                : False,                # plot during run
}
